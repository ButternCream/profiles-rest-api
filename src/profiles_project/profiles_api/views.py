...
class HelloApiView(APIView):
	...
	def put(self, request, pk=None):
		"""Handles updating objects. (pk = primary key)"""
...
class LoginViewSet(viewsets.ViewSet):
	"""Check email and passsword and returns an auth token."""

	serializer_class = AuthTokenSerializer

	def create(self, request):
		"""Use the ObtainAuthToken APIView to validate adn create a token."""
